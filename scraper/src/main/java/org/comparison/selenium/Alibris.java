...
/**
 * Demonstrates how you can use Selenium Chrome Driver to access data from
 * websites
...
public class Alibris {
    ...
    public void showHTML() {
        String item = "manga";
        // We need an options class to run headless - not needed if we want default
        // options
        ...
        // String link =
        // links.findElement(By.cssSelector("div.left")).getAttribute("href");
        // driver.get(link);
